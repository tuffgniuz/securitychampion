  ...
  return (
    <>
      {filteredSubCategories.map((sc) => {
        ...
        const isCollapsed = collapsed[sc.subCategoryId];
                      ...
                      {filteredRequirements.map((r) => (
                        ...
                        >
                          <td className="p-2 text-sm font-thin">
                            {highlightText(r.requirementId, searchQuery)}
                          </td>
                          <td
                            className="p-2"
                            onClick={() => handleRowClick(r.requirementId)}
                          >
                          ...
                          <td className="p-2">
                            <BookmarkButton requirementId={r.requirementId} />
                          </td>
                        </tr>
                      ))}
                    </tbody>
